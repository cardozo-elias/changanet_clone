...
const Footer = () => {
    ...
    const handleSubscribe = () => {
        ...
        if (emailRegex.test(email)) {
            // Simular envío a lista de suscriptores
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              ...
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 bg-[#10B981] rounded-full flex items-center justify-center mr-3">
                  <svg className="w-8 h-8" fill="none" stroke="white" viewBox="0 0 40 40">
                    ...
                    <path d="M12 20L15 23L20 20L25 23L28 20" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M8 17L12 20" stroke="white" stroke-width="2" stroke-linecap="round"/>
                    <path d="M32 17L28 20" stroke="white" stroke-width="2" stroke-linecap="round"/>
                  </svg>
                </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/" className="text-gray-300 hover:text-emerald-400 transition-colors duration-200 flex items-center">
                    <span className="mr-2">🏠</span>
                    Inicio
                  </Link>
                </li>
                <li>
                  <Link to="/profesionales" className="text-gray-300 hover:text-emerald-400 transition-colors duration-200 flex items-center">
                    <span className="mr-2">🔧</span>
                    Servicios
                  </Link>
                </li>
                <li>
                  <Link to="/para-profesionales" className="text-gray-300 hover:text-emerald-400 transition-colors duration-200 flex items-center">
                    <span className="mr-2">👥</span>
                    Para Profesionales
                  </Link>
                </li>
                <li>
                  <Link to="/contacto" className="text-gray-300 hover:text-emerald-400 transition-colors duration-200 flex items-center">
                    <span className="mr-2">📞</span>
                    Contacto
                  </Link>
                </li>
          ...
          <div className="border-t border-gray-700 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 text-sm">
                <Link to="/terminos" aria-label="Ir a Términos y Condiciones" className="text-gray-400 hover:text-emerald-400 hover:scale-105 hover:shadow-sm transition-all duration-300">
                  Términos y Condiciones
                </Link>
                <Link to="/privacidad" aria-label="Ir a Política de Privacidad" className="text-gray-400 hover:text-emerald-400 hover:scale-105 hover:shadow-sm transition-all duration-300">
                  Política de Privacidad
                </Link>
                <Link to="/cookies" aria-label="Ir a Política de Cookies" className="text-gray-400 hover:text-emerald-400 hover:scale-105 hover:shadow-sm transition-all duration-300">
                  Cookies
                </Link>
              </div>
            </div>
