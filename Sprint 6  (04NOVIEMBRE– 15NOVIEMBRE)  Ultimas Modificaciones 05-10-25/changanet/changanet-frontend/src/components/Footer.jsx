          ...
          <div className="border-t border-gray-700 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 text-sm">
                <Link to="/terminos" className="text-gray-400 hover:text-emerald-400 transition-colors duration-200">
                  Términos y Condiciones
                </Link>
                <Link to="/privacidad" className="text-gray-400 hover:text-emerald-400 transition-colors duration-200">
                  Política de Privacidad
                </Link>
                <Link to="/cookies" className="text-gray-400 hover:text-emerald-400 transition-colors duration-200">
                  Cookies
                </Link>
              </div>
            </div>
